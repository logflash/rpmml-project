...
from cleandiffuser.env.robomimic.robomimic_lowdim_wrapper import \
...
def make_env(args, idx):
    def thunk():
        ...
        env = VideoRecordingWrapper(
            env, video_recoder, file_path=None, steps_per_render=2
        )
...
def pipeline(args):
    ...
    if args.mode == "train":
        ...
        with open(
            f"/home/ubuntu/yyf/cleandiffuser/{args.exp_name}/metrics.jsonl", "w"
        ) as f:
