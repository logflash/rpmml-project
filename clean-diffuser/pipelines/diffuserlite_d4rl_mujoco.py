...
from cleandiffuser.dataset.d4rl_mujoco_dataset import \
    MultiHorizonD4RLMuJoCoDataset
...
from cleandiffuser.utils import DD_RETURN_SCALE, loop_dataloader, set_seed
from torch.utils.data import DataLoader


@hydra.main(
    config_path="../configs/diffuserlite/mujoco",
    config_name="mujoco",
    version_base=None,
)
def pipeline(args):
    ...
    target_return = (
        args.task.target_return_R2
        if args.test_model == "R2"
        else args.task.target_return_R1
    )
